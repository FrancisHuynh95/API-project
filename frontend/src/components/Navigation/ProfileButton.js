        ...
        <ul className={ulClassName} ref={ulRef}>
          {user ? (
            <>
              ...
              <li id="manageBookingsLi"><Link id="manageBookings" onClick={closeMenu} to="/reviews/current">Manage Reviews</Link></li>
              <li id="manageBookings"><Link id="manageBookings" onClick={closeMenu} to="/bookings/current">Manage Bookings</Link></li>
              <li>
